...
from constants import TANK_BULLET_EXPLOSION
...
class TankBulletExplosion(Explosion):
    ...
    """
    animation_speed = 0.3
    images = SpriteSheet.load_sprite_strip(TANK_BULLET_EXPLOSION, 1)

    def __init__(self, bullet, *groups):
        super().__init__(self.images, *groups)

        self.rect.x = bullet.rect.x - TANK_BULLET_EXPLOSION.width / 2
        self.rect.y = 0
